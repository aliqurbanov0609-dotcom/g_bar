...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#15232d] text-[#e0e5e9] font-sans selection:bg-[#E87A4A] selection:text-white flex justify-center">
      ...
      <div className="w-full max-w-[400px] h-[100dvh] md:h-[850px] md:my-auto md:rounded-[40px] app-container overflow-hidden flex flex-col relative md:border-[8px] md:border-[#0e161c]">
